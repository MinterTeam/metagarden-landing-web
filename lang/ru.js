export default {
	...
	'metagarden-chain': {
		...
		'games-item-button-more': 'Подробнее',
		...
		'index-games-heist-description': 'Свиньи-хакеры грабят копилку! Увлекательная многопользовательская игра, в которой игроки могут сорвать крупный куш, совершив ограбление века. Интуитивно понятный интерфейс, интересный геймплей, отличная крипто-игра, когда у вас есть свободная минутка.',
		'index-games-poker-description': 'Poker Hero – это онлайн покер с элементами RPG. Вы сможете играть за различных героев, которые имеют свой уникальный дизайн, уровни и игровую валюту. Героев можно прокачивать, обменивать или продавать, а также выигрывать их у соперников. Вы можете бросить вызов своим друзьям или принять участие в крупных турнирах и выиграть призы.',
		'index-games-100': 'За 2023-2024 год мы планируем запустить более 100 крипто-игр для Telegram',
		...
		'menu-testnet-url': 'https://scan.metagarden.io',
		...
		'menu-testnet-description': 'Релиз кандидат Metaharden Chain.',
		...
		'play-button': 'Играть',
		'platform-games-title': 'За 2023-2024 год мы планируем запустить более 100 крипто-игр для Telegram',
		'coming-soon': 'Скоро',
		'sec': 'сек',
		'min': 'мин',
		'from': 'от',
		...
		'menu-referral-description': 'Приглашайте друзей в Metagarden и получайте награды за их покупки токенов.',
		'hello-description-referral': 'Приглашайте друзей в Metagarden и получайте награды за их покупки токенов.',
		...
		'farmers-title': 'Уникальные NFT-фармеры',
		'farmers-description': 'Игры в Metagarden зарабатывают комиссии, фармер-боты их собирают и отправляют тебе.',
		'farmers-h1': 'Уникальные NFT-фармеры',
		'farmers-subtitle': 'Игры в Metagarden зарабатывают комиссии, фармер-боты их собирают и отправляют тебе.',
		'farmers-buy-button': 'Купить NFT-фармера в Лаунчпаде',
		'farmers-buy-button-url': 'https://t.me/metagardenbot?start=farmersru',
		'farmers-period': '* Срок добычи 6-18 месяцев в зависимости от выбранной игры.',
