export default {
	...
	'metagarden-chain': {
		'title': 'Metagarden Chain — продвинутый EVM-блокчейн 1 уровня для игр',
		...
		'hello-title': 'Продвинутый EVM-блокчейн для игр',
		'hello-description': 'Metagarden Chain – это первый EVM-блокчейн, разработанный специально для игр. Быстрые блоки, высокая пропускная способность, дешевое развертывание смарт-контрактов, дешевый минтинг NFT, дешевые транзакции, API и SDK для разработчиков игр и многие другие возможности.',
		...
		'menu-evm-url': '/ru',
		'menu-early-access-url': '/ru/early-access',
		...
		'f5': 'Быстрые блоки',
		'f6': 'Недорогой выпуск NFT',
		'f7': 'Недорогие транзакции',
